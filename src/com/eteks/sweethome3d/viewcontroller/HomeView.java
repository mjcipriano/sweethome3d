...
public interface HomeView extends View {
  ...
  public enum ActionType {
      ...
      SORT_HOME_FURNITURE_BY_CATALOG_ID, SORT_HOME_FURNITURE_BY_NAME, SORT_HOME_FURNITURE_BY_DESCRIPTION,
      SORT_HOME_FURNITURE_BY_CREATOR, SORT_HOME_FURNITURE_BY_LICENSE,
      ...
      DISPLAY_HOME_FURNITURE_CATALOG_ID, DISPLAY_HOME_FURNITURE_NAME, DISPLAY_HOME_FURNITURE_DESCRIPTION,
      DISPLAY_HOME_FURNITURE_CREATOR, DISPLAY_HOME_FURNITURE_LICENSE,
      ...
      DISPLAY_HOME_FURNITURE_VERTICES,
      ...
      MODIFY_ROOM, RECOMPUTE_ROOM_POINTS, ADD_ROOM_POINT, DELETE_ROOM_POINT, MODIFY_POLYLINE, MODIFY_DIMENSION_LINE, MODIFY_LABEL,
   ...
   * @since 7.2
   */
  public abstract void setActionEnabled(String actionKey,
                                        boolean enabled);
